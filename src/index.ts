...
export declare interface IPlugin {
   ...
   */
  setPlugins?(plugins:{[type:string]:Array<IPlugin>}):void;
}

/**
 * 基本プラグイン
 */
export declare interface IBasePlugin extends IPlugin {
  /**
   * audioContext参照
   * @return audioContext
   */
 ...
 * 表示フィールドプラグイン
 */
export declare interface IFieldPlugin extends IPlugin {
  /**
   * 描画動作
   */
  render():void;
 ...
 * メディアデータ合成
 */
export declare interface IMediaPlugin extends IPlugin {
  /**
   * 合成処理を実施する描画要素
 ...
 * 映像・音声元を管理する
 */
export declare interface ISourcePlugin extends IPlugin {
  /**
   * ソース選択実行時のpreview表示等
   */
 ...
 * 出力管理
 */
export declare interface IOutputPlugin extends IPlugin {
  /**
   * 設定部の表示
   */
 ...
 * source要素が保持してる情報データ
 */
export declare interface ISourceInfo {
  /**
   * 対応するplugin
   */
  plugin:IMediaPlugin;
